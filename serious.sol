...
contract YourContract  is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("YOUR Tokenss ", "TOKEN12") {
    ...
    function setSpearMintEnabled(bool isEnabled) external onlyOwner() {
        spearMintEnabled = isEnabled;
    }

    function setSpearMintFee(uint256 fee) external onlyOwner() {
        spearMintFee = fee;
    }
    ...
    function setDLVState(uint256 tokenId, uint stateId) external {
        ...
        require(msg.sender == ownerOf(tokenId) || msg.sender == owner(), "Sender is not Token Owner or Contract Deployer");
        require(stateId <= (STATE_COUNT - 1) && stateId >= 0, "Invalid State Value");
    ...
    function tokenURI(uint256 tokenId) public view virtual override(ERC721, ERC721URIStorage) returns (string memory) {
        ...
        return string(abi.encodePacked(base, _dlvIPFSSeriesDir, "/", uint2str(tokenId), ".", uint2str(stateId), ".json"));
    }
